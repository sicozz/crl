...
type GreeterClient interface {
	Hello(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Greeting, error)
}
...
func (c *greeterClient) Hello(ctx context.Context, in *Name, opts ...grpc.CallOption) (*Greeting, error) {
...
type GreeterServer interface {
	Hello(context.Context, *Name) (*Greeting, error)
...
func (UnimplementedGreeterServer) Hello(context.Context, *Name) (*Greeting, error) {
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Hello(ctx, req.(*Name))
	}
